...
if ( ! class_exists( 'OTPVG_Redirect_To_Checkout' ) ) {
	/**
	 * Class OTPVG_Redirect_To_Checkout
	 */
	class OTPVG_Redirect_To_Checkout {
		...
		public function __construct() {
			add_action( 'template_redirect', array( $this, 'otp_gateway_order_redirect' ) );
		}

		/**
		 * Redirecting to OTP-Verification page.
		 */
		public function otp_gateway_order_redirect() {
	...
	new OTPVG_Redirect_To_Checkout();
}
